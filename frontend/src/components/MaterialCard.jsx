    ...
    >
      ...
      <div className="flex-1 space-y-4">
        <div className="flex justify-between items-start">
          <div className="space-y-1">
             <div className="flex items-center gap-2">
                ...
                {hasAI && (
                   <span className="flex items-center gap-1 text-[10px] font-bold text-accent-500 tracking-wider uppercase bg-accent-50 dark:bg-accent-950/30 px-2 py-1 rounded-md">
        ...
        <div className="flex items-center gap-2 pt-2">
           <div className="w-6 h-6 rounded-full bg-gradient-to-tr from-slate-200 to-slate-300 dark:from-slate-700 dark:to-slate-800 flex items-center justify-center text-[10px] font-bold text-slate-600 dark:text-slate-300">
      ...
      <div className="mt-6 pt-6 border-t border-slate-100 dark:border-slate-800/50 flex items-center justify-between">
         ...
         <div className="flex gap-2">
            <Link to={`/materials/${material.id}`} className="p-3 bg-slate-50 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 rounded-xl transition-colors">
               <ExternalLink className="w-5 h-5"/>
            </Link>
            <button
              onClick={handleDownload}
              className="p-3 bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400 hover:bg-primary-500 hover:text-white rounded-xl transition-all duration-300 shadow-sm"
            >
