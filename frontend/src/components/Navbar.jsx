...
const Navbar = () => {
  ...
  const navLinks = user?.role === 'admin' 
    ...
    : [
        ...
        { name: 'Honey AI', path: '/ai-assistant', icon: <BrainCircuit className="w-5 h-5"/> },
        { name: 'Honey Teacher', path: '/honey-teacher', icon: <BrainCircuit className="w-5 h-5"/>, highlight: true },
